      ...
      <Navbar expand="lg" id="navbar">
        ...
        <Navbar.Collapse>
          <Nav className="menu">
            ...
            <Nav.Link className="menu-link" href="#link">Police</Nav.Link>
            <Nav.Link className="menu-link" href="#link">Atelier de réparation</Nav.Link>
            <NavDropdown className="menu-link" title="Assurance">
              <NavDropdown.Item href="#action/3.1">Auto-réclamation</NavDropdown.Item>
              <NavDropdown.Item href="#action/3.2">Gestion des réclamations</NavDropdown.Item>
